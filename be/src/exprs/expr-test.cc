...
TEST_F(ExprTest, TimestampFunctions) {
  ...
  TestIsNull("from_timestamp(cast('1970-01-01' as timestamp), 'yyyy-MM-dd HH:mm:ss')", TYPE_STRING);
  ...
  TestStringValue("from_timestamp(cast('2012-01-01 19:10:11+02:30' as timestamp), \
      'yyyy-MM-dd HH:mm:ss+hh:mm')", "2012-01-01 16:40:11");
  TestStringValue("from_timestamp(cast('2012-01-01 19:10:11-0630' as timestamp), \
      'yyyy-MM-dd HH:mm:ss-hhmm')", "2012-01-02 01:40:11");
  TestStringValue("from_timestamp(cast('2012-01-01 01:10:11+02' as timestamp), \
      'yyyy-MM-dd HH:mm:ss+hh')", "2011-12-31 23:10:11");
  TestStringValue("from_timestamp(cast('2012-12-31 11:10:11-1430' as timestamp), \
      'yyyy-MM-dd HH:mm:ss+hhmm')", "2013-01-01 01:40:11");
  TestStringValue("from_timestamp(cast('2012-01-01 11:10:11+1430' as timestamp), \
      'yyyy-MM-dd HH:mm:ss+hhmm')", "2011-12-31 20:40:11");
  TestStringValue("from_timestamp(cast('2012-02-28 11:10:11-1430' as timestamp), \
      'yyyy-MM-dd HH:mm:ss+hhmm')", "2012-02-29 01:40:11");
  TestStringValue("from_timestamp(cast('1970-01-01 00:00:00+05:00' as timestamp), \
      'yyyy-MM-dd HH:mm:ss+hh:mm')", "1969-12-31 19:00:00");
  TestStringValue("from_timestamp(cast('1400-01-01 19:00:00+1500' as timestamp), \
      'yyyy-MM-dd HH:mm:ss+hhmm')", "1400-01-01 04:00:00");
  TestStringValue("from_timestamp(cast('1400-01-01 02:00:00+0200' as timestamp), \
      'yyyy-MM-dd HH:mm:ss+hhmm')", "1400-01-01 00:00:00");
